...
exports.run = (client, message, args) => {
  ...
  message.channel.send('Kişiyi başarıyla uyardım.')
  return uyarilacak.send(`${sunucu} sunucusunda \`${sebep}\` sebebiyle uyarıldın. Bir daha aynısını yaparsan rollü uyarılacaksn!`);
};
